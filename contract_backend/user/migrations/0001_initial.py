    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_approval_type', models.CharField(choices=[('approver', 'approver'), ('legal_expert', 'legal expert'), ('simple_user', 'simple user')], default='simple user', max_length=255)),
