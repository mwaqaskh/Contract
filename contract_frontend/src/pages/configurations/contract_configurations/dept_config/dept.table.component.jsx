...
import { delDEPTStart } from '../../../../redux/config_dept/config_dept.actions';
import { selectDeptList } from '../../../../redux/config_dept/config_dept.selector';
import Modal from '@material-ui/core/Modal';
import DeptdelForm from './dept.del.form'
...
export default function BasicTable() {
    ...
    const body = (row) => (
        <div style={modalStyle} className={classes.paper}>
            <DeptdelForm setOpen={setOpen} row={row} />
        </div>
    );
    ...
    return (
        <TableContainer className={classes.table1} component={Paper} style={{ marginTop: "1.5em" }}>
            <Table aria-label="simple table">
                <TableHead>
                    <TableRow>
                        <TableCell className={classes.tablecell}>Available Departments</TableCell>
                        <TableCell></TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
